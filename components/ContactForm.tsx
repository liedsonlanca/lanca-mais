  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <button
        type="submit"
        disabled={submitting}
        className="w-full rounded-full bg-botao px-7 py-4 font-medium text-branco shadow-[0_0_32px_-10px_var(--color-salmon)] transition-all duration-500 hover:shadow-[0_0_48px_-6px_var(--color-salmon)] disabled:opacity-60"
      >
