...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="botao-whatsapp fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-salmon text-preto shadow-lg shadow-tinta/20 transition-transform hover:scale-105"
    >
