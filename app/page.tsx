    ...
    <Painel key="servicos" claro={claro}>
      <Miolo className="py-12 lg:py-16">
        ...
        {/* Os outros serviços: só o convite, centralizado.
            ...
            Já foram uma frase corrida com os cinco nomes, e depois uma lista
            com um por linha. As duas versões competiam com os três cards logo
            acima, que são o assunto do bloco, e a lista ainda puxava o olho
            para baixo com cinco linhas de texto secundário.

            Nada se perde de alcance: as oito frentes continuam listadas no
            rodapé de toda página, então quem procura uma delas acha, e os
            buscadores também. */}
        {outros.length > 0 && (
          <Reveal delay={0.15}>
            <div className={`mt-10 flex justify-center border-t ${FIO} pt-9`}>
              <Botao href="/servicos" variante={claro ? "contraste" : "vazado"}>
